    ...
    return (
        <PomodoroProvider>
            <div className="fixed right-4 top-1/2 -translate-y-1/2 z-30 w-72 flex flex-col gap-2">
                ...
                {/* Widgets - Each wrapped in DraggableWidget */}
                <div className="flex flex-col gap-3">
                    {isVisible('pomodoro') && (
                        <DraggableWidget
                            ...
                            title="Pomodoro"
                            icon="🍅"
                            headerClassName="bg-gradient-to-r from-red-600 to-orange-500"
                        >
                            <PomodoroWidget />
                        </DraggableWidget>
                    )}
                    {isVisible('weather') && (
                        <DraggableWidget
                            ...
                            title="Hava Durumu"
                            icon="🌤️"
                            headerClassName="bg-gradient-to-r from-sky-500 to-indigo-600"
                        >
                            <WeatherWidget />
                        </DraggableWidget>
                    )}
                    {isVisible('notes') && (
                        <DraggableWidget
                            ...
                            title="Hızlı Not"
                            icon="📝"
                            headerClassName="bg-gradient-to-r from-amber-400 to-yellow-500"
                        >
                            <StickyNoteWidget />
                        </DraggableWidget>
                    )}
